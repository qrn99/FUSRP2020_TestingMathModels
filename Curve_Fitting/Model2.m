function Model2()
%MODEL2 Test the Time Delay Model with 4 breakfast glucose curves and 4
...
params(15)=L_initial; %initial glucose in ileum
...
for i=1:size(data,2)
    ...
    fun=@(params)(Cost(params, gdata,2));
    ...
    [t,y] = ode45(@(t,y) timeDelayODE(t,y,x),tspan,init_val);
...
title("Time Delay Model Breakfast")
...
%and actual glucose values
ActualvsModel(gstore(:,1),gstore(:,2))
title("Time Delay Model Lunch")
%write optimized parameters for each curve fitting into the following excel
%file
writematrix([storeBreakfastParam; storeLunchParam],'WithTimeDelayParameters.xlsx')
end
